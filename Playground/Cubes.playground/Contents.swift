...
*/
sceneView.backgroundColor = NSColor(colorLiteralRed: 0.1956433057785034, green: 0.2113749980926514, blue: 0.2356699705123901, alpha: 1)
...
cube.firstMaterial?.diffuse.contents = NSColor(colorLiteralRed: 0.3, green: 0.4, blue: 0.5, alpha: 1.0)
...
animation.values = [NSValue(scnVector4: SCNVector4(1, 1, 0.3, 0 * Double.pi)),
                    NSValue(scnVector4: SCNVector4(1, 1, 0.3, 1 * Double.pi)),
                    NSValue(scnVector4: SCNVector4(1, 1, 0.3, 2 * Double.pi))]
...
let tapRecognizer = UITapGestureRecognizer(target: touchHandler, action: #selector(TouchHandler.tapGestureRecognized(recognizer:)))
